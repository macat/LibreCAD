...
enum CommandRegistry {
    ...
    static func commands(_ actions: Actions) -> [PaletteCommand] {
        ...
        list.append(contentsOf: [
            ...
            PaletteCommand(id: "constrain.collinear", title: "Constrain: Collinear",
                           systemImage: "line.diagonal",
                           run: { actions.applyGeometricConstraint(.collinear) }),
            PaletteCommand(id: "constrain.concentric", title: "Constrain: Concentric",
                           systemImage: "circle.circle",
                           run: { actions.applyGeometricConstraint(.concentric) }),
            PaletteCommand(id: "constrain.equal", title: "Constrain: Equal",
                           systemImage: "equal",
                           run: { actions.applyGeometricConstraint(.equal) }),
            ...
            PaletteCommand(id: "constrain.diameter", title: "Constrain: Diameter (lock current)",
                           systemImage: "circle.dashed",
                           run: { actions.applyDimensionalConstraint(.diameter) }),
            PaletteCommand(id: "constrain.angle", title: "Constrain: Angle (lock current)",
                           systemImage: "angle",
                           run: { actions.applyDimensionalConstraint(.angle) }),
            PaletteCommand(id: "constrain.hdistance", title: "Constrain: Horizontal Distance (lock current)",
                           systemImage: "arrow.left.and.right",
                           run: { actions.applyDimensionalConstraint(.horizontalDistance) }),
            PaletteCommand(id: "constrain.vdistance", title: "Constrain: Vertical Distance (lock current)",
                           systemImage: "arrow.up.and.down",
                           run: { actions.applyDimensionalConstraint(.verticalDistance) }),
