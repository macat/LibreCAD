...
- [2026-06-11 16:55] 🔨 foundation-fixer (general-purpose, worktree on ws/foundation) — apply must-fix arc-bbox + closed-polyline; widen ResolvedFill→loops; reserve ResolveContext hooks; CADEngine.init private; mintID docs; +tests. Outcome: running. Receipts: ws/foundation (pending).
