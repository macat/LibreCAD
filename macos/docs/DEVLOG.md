...
- [2026-06-11 15:40] 🔍 scaffold-reviewer (general-purpose) — review ws/scaffold before merge (Swift6 concurrency, C-ABI shim safety, Package/Metal correctness, ADR alignment). Outcome: running. Receipts: verdict inline (pending).
