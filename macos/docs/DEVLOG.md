...
- [2026-06-11 14:31] 🔬 ui-inventory (general-purpose) — full LibreCAD tool/command/UI inventory + P0/P1/P2 + modern-Mac take. Outcome: running. Receipts: macos/docs/feature-inventory.md (pending).
